      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex gap-6">
              ...
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="hover:text-indigo-600">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {categories.map(category => (
                <li key={category.id}>
                  <Link to={`/${category.slug}`} className="text-gray-400 hover:text-white">
                    {category.name}
                  </Link>
                </li>
              ))}
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="text-center text-gray-400 mb-4">
            ©2025 InsideTheBuzz. All Rights Reserved
          </div>
